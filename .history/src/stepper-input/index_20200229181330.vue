...
export default {
  ...
  data() {
    return {
      ...
      numbers: [{ num: 1, isShowStepper: true, inputModel: eval('inputModel1') }],
    };
  },
  ...
  methods: {
    onChange(value) {
      if (value - this.numbers.length === 1) {
        ...
        this.numbers.push({ num: value, isShowStepper: true, inputModel: 'inputModel' + value });
        this.$emit('onclick', value);
      }
      if (value - this.numbers.length === -1) {
        this.numbers.pop({ num: value, isShowStepper: true, inputModel: 'inputModel' + value });

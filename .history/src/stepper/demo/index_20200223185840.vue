  ...
  <div class="demo-div">
    <demo-section>
      ...
      <demo-block :title="decimalLength">
        <van-stepper v-model="stepper7" :decimal-length="1" step="0.2" />
      </demo-block>

      <demo-block :title="customSize">
        <van-stepper v-model="stepper6" :show-minus="false" button-size="32px" input-width="40px" />
      </demo-block>
    </demo-section>
  </div>
</template>
